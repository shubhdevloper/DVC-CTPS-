...
function OutgoingPage() {
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Outgoing Records");
    XLSX.writeFile(workbook, "outgoing-register.xlsx");
  };
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "20px 10px" }}>
      ...
      <div className="breadcrumb">
        ...
        <span className="bc-cur">Outgoing Material Register</span>
      </div>

      {/* Page Title Bar */}
      <div className="page-title-bar" style={{ marginTop: 10 }}>
        <div style={{ flex: 1 }}>
          <h2>Outgoing Material Register</h2>
          <p>Complete Outgoing Material Register — all gates</p>
        </div>
      ...
      <div className="panel" style={{ marginTop: 14 }}>
        <div className="panel-head">
          <h4>Outgoing Material Register — Filter &amp; Search</h4>
        </div>
      ...
      {showResults && (
        <>
          ...
          {/* Table */}
          <div className="records-section-title out">📋 Outgoing Material Register</div>
