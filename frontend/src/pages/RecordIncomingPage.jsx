...
function RecordIncomingPage() {
  ...
  const inputClass =
    "w-full border border-slate-300 bg-slate-50 rounded px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500";
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    Swal.fire({
      ...
      title: "Success",
      text:
        "Incoming Entry Recorded Successfully",
      confirmButtonColor:
        "#e65100",
    });
  ...
  return (
    <div style={{ maxWidth: "760px", margin: "0 auto" }}>
      ...
      <div className="breadcrumb">
        ...
        <span className="bc-cur">Record Incoming Material</span>
      </div>
      ...
      <div className="panel">
        <div className="page-title-bar" style={{ borderRadius: "3px 3px 0 0", marginBottom: 0 }}>
          <div>
            <h2>Record Incoming Material</h2>
            <p>Fill in all details as per the Incoming Material Register</p>
          </div>
          <div className="page-title-bar-right">{new Date().toLocaleString()}</div>
        </div>

        <div className="panel-head" style={{ borderRadius: 0 }}>
          <h4>Incoming Material Register — Record New Entry</h4>
        </div>
        ...
        <div className="panel-body">
          ...
          <div className="fg3">
            ...
            <div className="ff">
              <label>TIME IN <span className="req">*</span></label>
          ...
          <div className="ff">
            ...
            <select name="materialType" value={formData.materialType} onChange={handleChange}>
              ...
              <option>Cable</option><option>Electrical Equipment</option>
              <option>Mechanical Spare</option><option>Pipe</option>
              <option>Valve</option><option>Bearing</option>
              <option>Lubricant</option><option>Chemical</option>
              <option>Construction Material</option><option>Safety Equipment</option>
              <option>Tool</option><option>Document</option>
              <option>Consumable</option><option>Others</option>
            </select>
          </div>
          ...
          <div className="ff">
            ...
            <textarea rows="3" name="materialDescription" value={formData.materialDescription} onChange={handleChange} placeholder="Describe the materials being received..." />
          </div>
...
export default RecordIncomingPage;
